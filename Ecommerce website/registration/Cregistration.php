...
<div class="register">
    ...
    <form id="register"method="post">
       ...
       <br>
       <input type="text" name="fullName" id="name" placeholder="Enter Your Full Name" require>
       <br><br>

       <label>Email Address </label>
       <br>
       <input type="text" name="emailAddress" id="name" placeholder="Enter Your Valid EmailAdress" require>
       <br><br>

       <label>Address</label>
       <br>
       <input type="text" name="address" id="name" placeholder="Enter Your Address Here" require>
       <br><br>

       <label>Password</label>
       <br>
       <input type="password" name="password" id="name" placeholder="Enter Password Here" require>
       <br><br>

       <label>Confirm Password</label>
       <br>
       <input type="password" name="confirmPwd" id="name" placeholder="Enter Confirm Password Here" require>
       <br><br>
       ...
       &nbsp;
       <input type="radio" name="gender" id="others" value="Others" require>
